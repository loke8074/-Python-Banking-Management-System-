...
title='WELCOME TO SBI BANK MANAGEMENT SYSTEM'
clientNames = ['lokesh','raja','harish','mahesh','sai']
ClientPins = ['2255','9744','5444','5410','9721']
...
while True:
    # os.system("cls")
    print("************************************************************")
    print("========== WELCOME TO HOME BANKING SYSTEM ==========")
    print("************************************************************")
                ...
                if name == clientNames[w]:
                    if pin == ClientPins[w]:
                        ...
                        if ClientWithdrawal > ClientBalance:
                            ...
                            print("Your New Balance: ",ClientBalance, end=" ")
                            print("\n\n")
                        else:
                            ClientBalance = ClientBalance - ClientWithdrawal
                            print("\n")
